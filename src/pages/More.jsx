...
function More() {
  return (
    <>
    <div className="p-6 text-white h-screen flex flex-col justify-center" id="more">
      <h2 className="text-3xl font-bold mb-4">🚀 More About Me</h2>

      <section className="mb-6">
        <h3 className="text-xl font-semibold">🛤️ My Tech Journey</h3>
        <p className="text-gray-700">
          I started coding in 2023, initially exploring Java. Over time, I got into web development and fell in love with building beautiful, responsive UIs using React.
        </p>
      </section>
